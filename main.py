...
class Notepad:
    ...
    def __init__(self,**kwargs):
        ...
        try:
                ...
                pass
        self.__root.title("Untitled - Bloco de Notas")
        ...
        self.__thisMenuBar.add_cascade(label="Arquivos", menu=self.__thisFileMenu)
        self.__thisEditMenu.add_command(label="Recortar", command=self.__cut)
        ...
        self.__thisHelpMenu.add_command(label="Sobre o Bloco de Notas", command=self.__showAbout)
